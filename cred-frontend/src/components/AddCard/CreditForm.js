...
export default function CreditForm() {
    ...
    return (
        <div className={classes.cardform}>
            <div className={classNames(classes.card, classes.container, showcard ? classes.show : "")}>
                    ...
                    <div className={classes.front}>
                        ...
                        <div className={classNames(classes.card, classes.content)}>
                            ...
                            >
                                {displayNumber.map((digit, index) => (
                                    <div className={classes.digitwrapper} key={index}>
                                        <div
                                            className={
                                                digit === "#" ? classNames(classes.digit, classes.shown) : classNames(classes.digit, classes.hidden)
                                            }
                                        >
                                            #
                      </div>
                                        <div
                                            className={
                                                digit === "#" ? classNames(classes.digit, classes.hidden) : classNames(classes.digit, classes.shown)
                                            }
                                        >
                                            {digit === "#" ? "" : digit}
                                        </div>
                            ...
                            >
                                ...
                                <div id="name">
                                    <div
                                        className={classNames(classes.placeholder, cardName.length > 0 ? classes.hidden : classes.shown
                                        )}
                                    >
                                        FULL NAME
                    </div>
                                    <div className={classes.nameContainer}>
                                        {cardName.split("").map((char, index) => (
                                            <div
                                                className={classNames(classes.character, `${/\s/.test(char)}` ? classes.space : ""
                                                )}
                                                key={index}
                                            >
                                                {char}
                            ...
                            >
                                ...
                                <div id="expiration">
                                    <div
                                        className={classNames(classes.doubledigit, `${toggleMonth}` ? classes.toggle1 : classes.toggle2
                                        )}
                                    >
                                    ...
                                    <div
                                        className={classNames(classes.year, classes.doubledigit, `${toggleYear}` ? classes.toggle1 : classes.toggle2
                                        )}
            ...
            <div className={classes.cardInputs}>
                <form onSubmit={handleSubmit(onSubmit)} className={classes.form}>
                    ...
                    <div className={classes.lginput}>
                        <label htmlFor="cardName" className={classes.label}>Card Holder's Name</label>
                        <input
                    ...
                    <div className={classes.medinput}>
                        <label htmlFor="cardMonth" className={classes.label}>Expiration Date</label>
                        <select
                            className={classNames(classes.input, classes.monthinput, classes.select)}
                            id="cardMonth"
                            name="month"
                            ref={register}
                            value={cardMonth}
                        ...
                        <select
                            className={classNames(classes.input, classes.yearinput, classes.select)}
                            id="cardYear"
                            name="year"
                            ref={register}
                            value={cardYear}
